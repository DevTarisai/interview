...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
		...
		<span class="patient-inspan">Temperature</span>
                
        
         <form action="temperature_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          
           <tr>
            <td><h6>Temperature Measure</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="&deg;F" name="temperature" /></td>
          </tr>
           <tr>
            <td><h6>Temperature Date</h6></td>
            <td><input type="date" class="ehrinput4" name="date"/></td>
          </tr>
          ...
          <tr>
            <td><h6>Time</h6></td>
            <td><input type="text" class="ehrinput4" placeholder="e.g:11:30am" name="time"/></td>
