...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
		...
		<span class="patient-inspan">Surgery Details</span>
                
      
         <form action="lft_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          
           <tr>
            <td><h6>SGPT:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="SGPT" name="sgpt" /></td>
          </tr>
           </tr>
           
            <td><h6>SGOT:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="SGOT " name="sgot" /></td>
          </tr>
