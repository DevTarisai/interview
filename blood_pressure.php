...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
		...
		<span class="patient-inspan">Lab Results</span>
         ...
         <form action="blood-pressure_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
           
           <tr>
            <td><h6>Blood Pressure:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="Blood Pressure" name="blood_pressure" /></td>
          </tr>
