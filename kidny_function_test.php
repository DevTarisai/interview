...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
		...
		<span class="patient-inspan">Lab Results</span>
         ...
         <form action="kidny_function_test_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
           
           <tr>
            <td><h6>Urea:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="Urea" name="urea" /></td>
          </tr>

          <tr>
            <td><h6>Creotanin:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="Creotanin" name="creotanin" /></td>
          </tr>
