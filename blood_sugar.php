...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
		...
		<span class="patient-inspan">Blood Sugar</span>
                
        
        <form action="blood_sugar_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          

           <tr>
            <td><h6>Fasting:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="Fasting " name="fasting" /></td>
          </tr>
          
          <tr>
            <td><h6>PP:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="PP" name="pp" /></td>
          </tr>
