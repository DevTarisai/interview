...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
		...
		<span class="patient-inspan">User Registration</span>
                
      
         <form action="user_registration_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">

          <p><h3><strong> Create Account</strong></h3></p>
           <tr>
            <td><h6>Patient Name</h6></td>
            <td><span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" name="patient_fname" /></span>
            <span class="ehrinputname2"><input type="text" class="ehrinput" placeholder="Last Name" name="patient_lname" /></span></td>
          </tr>
          
          <tr>
            <td><h6>Contact Number</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="Contact Number" name="contact_no" /></td>
          </tr>
