...
$query = "select * from patient_info p, blood_pressure c where p.uhid=c.patient_id and c.patient_id=$ptid  ORDER BY date DESC ";
    ...
    ?>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><h6> <?php echo "$blood_pressure ";?></h6></td>
...
<div class="patient-infobg">
        ...
        <span class="patient-hisspan"><input type="checkbox" name ="thyroid" value="on">   THYROID TEST</span>
        <table border="0" cellspacing="0" cellpadding="0">
...
$query = "select * from patient_info p, thyroid t where p.uhid=t.patient_id and p.uhid=$ptid  ORDER BY date DESC ";
              ...
              $j=0;
                      ...
                      { 
                        ...
                        // $total_cholesterol    =mysql_result($result,$j,"total_cholesterol  ");
                         $date=mysql_result($result,$j,"date");
    ...
    ?>
          ...
          <tr>
            ...
            <td><p> <?php echo date('y-m-d', strtotime($date) ); ?></p></td>
            <?php 
            $j++; 
            }
            ?>
   ...
   <div class="patient-infogap"></div>
         <span class="patient-hisspan">KIDNEY FUNCTION TEST</span>
        <table border="0" cellspacing="0" cellpadding="0">
        <tr>
        <td><p><strong>UREA</strong></p></td>
