...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
		...
		<span class="patient-inspan">Hemoglobin</span>
                
        
         <form action="hemoglobin_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
         <tr>
           ...
           <tr>
            <td><h6>Hemoglobin:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="Hemoglobin" name="hemoglobin" /></td>
          </tr>
