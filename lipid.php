...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
    ...
    <span class="patient-inspan">Lipid Test</span>
                
        
         <form action="lipid_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
           
           <tr>
            <td><h6>LGL:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="LGL" name="lgl" /></td>
          </tr>
           
          
           <tr>
            <td><h6>VGL:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="VGL" name="vgl" /></td>
          </tr>
           ...
           <tr>
            <td><h6>HTL:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="HTL" name="htl" /></td>
          </tr>

            
           
           <tr>
            <td><h6>Total Cholesterol:</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="Total Cholesterol" name="total_cholesterol" /></td>
          </tr>
