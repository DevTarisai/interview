...
<!-------------<span class="ehrinputname"><input type="text" class="ehrinput" placeholder="First Name" /></span>
    ...
    <span class="patient-inspan">Thyroid Test</span>
                
        
         <form action="thyroid_script.php" method="post" >
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
           
           <tr>
            <td><h6>T1</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="T1" name="t1" /></td>
          </tr>
           
          
           <tr>
            <td><h6>T2</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="T2" name="t2" /></td>
          </tr>
           ...
           <tr>
            <td><h6>TSH</h6></td>
            <td><input type="text" class="ehrinput2" placeholder="TSH" name="tsh" /></td>
          </tr>
